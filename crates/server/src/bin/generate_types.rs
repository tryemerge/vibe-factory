...
// If you are an AI, and you absolutely have to edit this file, please confirm with the user first.";
    ...
    let decls: Vec<String> = vec![
        ...
        db::models::station_step::StationStep::decl(),
        db::models::station_step::CreateStationStep::decl(),
        db::models::station_step::UpdateStationStep::decl(),
        ...
        db::models::task_step_execution::TaskStepExecution::decl(),
        db::models::task_step_execution::CreateTaskStepExecution::decl(),
        db::models::task_step_execution::UpdateTaskStepExecution::decl(),
        db::models::task_step_execution::TaskStepExecutionStatus::decl(),
