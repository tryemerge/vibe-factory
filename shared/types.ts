...
export type TaskAttempt = { id: string, task_id: string, worktree_path: string, merge_commit: string | null, executor: string | null, session_id: string | null, created_at: string, updated_at: string, };
