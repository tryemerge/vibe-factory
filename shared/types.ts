...
export type OpenEditorError = { "type": "ide_cli_not_found", editor_type: EditorType, cli_command: string, } | { "type": "invalid_config", message: string, } | { "type": "io", message: string, };
