...
>(({ className, maxRows = 10, ...props }, ref) => {
  ...
  return (
    <textarea
      className={cn(
        'p-0 min-h-[80px] w-full text-sm placeholder:text-muted-foreground outline-none disabled:cursor-not-allowed disabled:opacity-50 resize-none overflow-y-auto',
        className
      )}
      ref={textareaRef}
      onInput={handleInput}
